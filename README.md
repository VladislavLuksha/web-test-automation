...
## 📝 Тест-кейсы
1. **Переход в корзину с 1 неакционным товаром**
2. **Переход в корзину с 1 акционным товаром**
3. **Переход в корзину с 9 разными товарами**
4. **Переход в корзину с 9 акционными товарами одного наименования**
